  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm-md-0 scroll-m-[100rem]">
      ...
      >
        ...
        <a href="/CV.pdf" download="/CV.pdf" className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/5">
